...
class DIR3Service:
    ...
    async def create_dir3(self, dir3_data: DIR3Create, user_id: int) -> DIR3:
    ...
    async def get_dir3s(self, skip: int = 0, limit: int = 100) -> List[DIR3]:
        """Get all active dir3s with pagination"""
        try:
            return list((await self.db.execute(select(DIR3).where(
                DIR3.is_active == True
    ...
    async def get_dir3s_by_company(self, company_id: int) -> List[DIR3]:
    ...
    async def update_dir3(self, dir3_id: int, dir3_data: DIR3Update, user_id: int) -> Optional[DIR3]:
    ...
    async def delete_dir3(self, dir3_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, dir3_id: int, status: bool, user_id: int) -> bool:
