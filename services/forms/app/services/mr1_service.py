...
class MR1Service:
    ...
    def create_mr1(self, mr1_data: MR1Create, user_id: int) -> MR1:
    ...
    def get_mr1(self, mr1_id: int) -> Optional[MR1]:
        """Get a mr1 by ID"""
        try:
    ...
    def get_mr1s(self, skip: int = 0, limit: int = 100) -> List[MR1]:
    ...
    def get_mr1s_by_company(self, company_id: int) -> List[MR1]:
    ...
    def update_mr1(self, mr1_id: int, mr1_data: MR1Update, user_id: int) -> Optional[MR1]:
        """Update a mr1 record"""
        try:
    ...
    def delete_mr1(self, mr1_id: int, user_id: int) -> bool:
    ...
    def change_status(self, mr1_id: int, status: bool, user_id: int) -> bool:
