...
class IEPF5Service:
    ...
    def create_iepf5(self, iepf5_data: IEPF5Create, user_id: int) -> IEPF5:
    ...
    def get_iepf5(self, iepf5_id: int) -> Optional[IEPF5]:
        """Get a iepf5 by ID"""
        try:
    ...
    def get_iepf5s(self, skip: int = 0, limit: int = 100) -> List[IEPF5]:
    ...
    def get_iepf5s_by_company(self, company_id: int) -> List[IEPF5]:
    ...
    def update_iepf5(self, iepf5_id: int, iepf5_data: IEPF5Update, user_id: int) -> Optional[IEPF5]:
    ...
    def delete_iepf5(self, iepf5_id: int, user_id: int) -> bool:
    ...
    def change_status(self, iepf5_id: int, status: bool, user_id: int) -> bool:
