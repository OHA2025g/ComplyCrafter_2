...
class INC20AService:
    ...
    async def create_inc20a(self, inc20a_data: INC20ACreate, user_id: int) -> INC20A:
    ...
    async def get_inc20as(self, skip: int = 0, limit: int = 100) -> List[INC20A]:
        """Get all active inc20as with pagination"""
        try:
            return list((await self.db.execute(select(INC20A).where(
    ...
    async def get_inc20as_by_company(self, company_id: int) -> List[INC20A]:
    ...
    async def update_inc20a(self, inc20a_id: int, inc20a_data: INC20AUpdate, user_id: int) -> Optional[INC20A]:
    ...
    async def delete_inc20a(self, inc20a_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, inc20a_id: int, status: bool, user_id: int) -> bool:
