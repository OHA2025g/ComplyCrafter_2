...
class CHG9Service:
    ...
    def create_chg9(self, chg9_data: CHG9Create, user_id: int) -> CHG9:
    ...
    def get_chg9(self, chg9_id: int) -> Optional[CHG9]:
        """Get a chg9 by ID"""
        try:
    ...
    def get_chg9s(self, skip: int = 0, limit: int = 100) -> List[CHG9]:
    ...
    def get_chg9s_by_company(self, company_id: int) -> List[CHG9]:
    ...
    def update_chg9(self, chg9_id: int, chg9_data: CHG9Update, user_id: int) -> Optional[CHG9]:
    ...
    def delete_chg9(self, chg9_id: int, user_id: int) -> bool:
    ...
    def change_status(self, chg9_id: int, status: bool, user_id: int) -> bool:
