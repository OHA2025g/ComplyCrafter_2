...
class MGT8Service:
    ...
    def create_mgt8(self, mgt8_data: MGT8Create, user_id: int) -> MGT8:
    ...
    def get_mgt8(self, mgt8_id: int) -> Optional[MGT8]:
        """Get a mgt8 by ID"""
        try:
    ...
    def get_mgt8s(self, skip: int = 0, limit: int = 100) -> List[MGT8]:
    ...
    def get_mgt8s_by_company(self, company_id: int) -> List[MGT8]:
    ...
    def update_mgt8(self, mgt8_id: int, mgt8_data: MGT8Update, user_id: int) -> Optional[MGT8]:
    ...
    def delete_mgt8(self, mgt8_id: int, user_id: int) -> bool:
    ...
    def change_status(self, mgt8_id: int, status: bool, user_id: int) -> bool:
