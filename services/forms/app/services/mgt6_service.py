...
class MGT6Service:
    ...
    def create_mgt6(self, mgt6_data: MGT6Create, user_id: int) -> MGT6:
    ...
    def get_mgt6(self, mgt6_id: int) -> Optional[MGT6]:
        """Get a mgt6 by ID"""
        try:
    ...
    def get_mgt6s(self, skip: int = 0, limit: int = 100) -> List[MGT6]:
    ...
    def get_mgt6s_by_company(self, company_id: int) -> List[MGT6]:
    ...
    def update_mgt6(self, mgt6_id: int, mgt6_data: MGT6Update, user_id: int) -> Optional[MGT6]:
    ...
    def delete_mgt6(self, mgt6_id: int, user_id: int) -> bool:
    ...
    def change_status(self, mgt6_id: int, status: bool, user_id: int) -> bool:
