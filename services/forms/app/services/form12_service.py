...
class Form12Service:
    ...
    def create_form12(self, form12_data: Form12Create, user_id: int) -> Form12:
    ...
    def get_form12(self, form12_id: int) -> Optional[Form12]:
        """Get a form12 by ID"""
        try:
            return self.db.query(Form12).filter(
    ...
    def get_form12s(self, skip: int = 0, limit: int = 100) -> List[Form12]:
    ...
    def get_form12s_by_company(self, company_id: int) -> List[Form12]:
    ...
    def update_form12(self, form12_id: int, form12_data: Form12Update, user_id: int) -> Optional[Form12]:
        """Update a form12 record"""
        try:
            form12 = self.get_form12(form12_id)
            if not form12:
                return None
    ...
    def delete_form12(self, form12_id: int, user_id: int) -> bool:
    ...
    def change_status(self, form12_id: int, status: bool, user_id: int) -> bool:
