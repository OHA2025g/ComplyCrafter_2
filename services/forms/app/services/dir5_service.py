...
class DIR5Service:
    ...
    def create_dir5(self, dir5_data: DIR5Create, user_id: int) -> DIR5:
    ...
    def get_dir5(self, dir5_id: int) -> Optional[DIR5]:
        """Get a dir5 by ID"""
        try:
    ...
    def get_dir5s(self, skip: int = 0, limit: int = 100) -> List[DIR5]:
    ...
    def get_dir5s_by_company(self, company_id: int) -> List[DIR5]:
    ...
    def update_dir5(self, dir5_id: int, dir5_data: DIR5Update, user_id: int) -> Optional[DIR5]:
    ...
    def delete_dir5(self, dir5_id: int, user_id: int) -> bool:
    ...
    def change_status(self, dir5_id: int, status: bool, user_id: int) -> bool:
