...
class INC23Service:
    ...
    async def create_inc23(self, inc23_data: INC23Create, user_id: int) -> INC23:
    ...
    async def get_inc23s(self, skip: int = 0, limit: int = 100) -> List[INC23]:
        """Get all active inc23s with pagination"""
        try:
            return list((await self.db.execute(select(INC23).where(
    ...
    async def get_inc23s_by_company(self, company_id: int) -> List[INC23]:
    ...
    async def update_inc23(self, inc23_id: int, inc23_data: INC23Update, user_id: int) -> Optional[INC23]:
    ...
    async def delete_inc23(self, inc23_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, inc23_id: int, status: bool, user_id: int) -> bool:
