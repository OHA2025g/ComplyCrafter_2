...
class DIR11Service:
    ...
    def create_dir11(self, dir11_data: DIR11Create, user_id: int) -> DIR11:
    ...
    def get_dir11(self, dir11_id: int) -> Optional[DIR11]:
        """Get a dir11 by ID"""
        try:
    ...
    def get_dir11s(self, skip: int = 0, limit: int = 100) -> List[DIR11]:
    ...
    def get_dir11s_by_company(self, company_id: int) -> List[DIR11]:
    ...
    def update_dir11(self, dir11_id: int, dir11_data: DIR11Update, user_id: int) -> Optional[DIR11]:
    ...
    def delete_dir11(self, dir11_id: int, user_id: int) -> bool:
    ...
    def change_status(self, dir11_id: int, status: bool, user_id: int) -> bool:
