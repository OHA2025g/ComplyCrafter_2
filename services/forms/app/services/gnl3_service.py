...
class GNL3Service:
    ...
    async def create_gnl3(self, gnl3_data: GNL3Create, user_id: int) -> GNL3:
    ...
    async def get_gnl3s(self, skip: int = 0, limit: int = 100) -> List[GNL3]:
        """Get all active gnl3s with pagination"""
        try:
            return list((await self.db.execute(select(GNL3).where(
                GNL3.is_active == True
    ...
    async def get_gnl3s_by_company(self, company_id: int) -> List[GNL3]:
    ...
    async def update_gnl3(self, gnl3_id: int, gnl3_data: GNL3Update, user_id: int) -> Optional[GNL3]:
    ...
    async def delete_gnl3(self, gnl3_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, gnl3_id: int, status: bool, user_id: int) -> bool:
