...
class SH11Service:
    ...
    async def create_sh11(self, sh11_data: SH11Create, user_id: int) -> SH11:
    ...
    async def get_sh11s(self, skip: int = 0, limit: int = 100) -> List[SH11]:
        """Get all active sh11s with pagination"""
        try:
            return list((await self.db.execute(select(SH11).where(
                SH11.is_active == True
    ...
    async def get_sh11s_by_company(self, company_id: int) -> List[SH11]:
    ...
    async def update_sh11(self, sh11_id: int, sh11_data: SH11Update, user_id: int) -> Optional[SH11]:
    ...
    async def delete_sh11(self, sh11_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, sh11_id: int, status: bool, user_id: int) -> bool:
