...
class CHG1Service:
    ...
    async def create_chg1(self, chg1_data: CHG1Create, user_id: int) -> CHG1:
    ...
    async def get_chg1s(self, skip: int = 0, limit: int = 100) -> List[CHG1]:
        """Get all active chg1s with pagination"""
        try:
            return list((await self.db.execute(select(CHG1).where(
                CHG1.is_active == True
    ...
    async def get_chg1s_by_company(self, company_id: int) -> List[CHG1]:
    ...
    async def update_chg1(self, chg1_id: int, chg1_data: CHG1Update, user_id: int) -> Optional[CHG1]:
    ...
    async def delete_chg1(self, chg1_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, chg1_id: int, status: bool, user_id: int) -> bool:
