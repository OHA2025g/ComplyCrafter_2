...
class Form28Service:
    ...
    def create_form28(self, form28_data: Form28Create, user_id: int) -> Form28:
    ...
    def get_form28(self, form28_id: int) -> Optional[Form28]:
        """Get a form28 by ID"""
        try:
            return self.db.query(Form28).filter(
    ...
    def get_form28s(self, skip: int = 0, limit: int = 100) -> List[Form28]:
    ...
    def get_form28s_by_company(self, company_id: int) -> List[Form28]:
    ...
    def update_form28(self, form28_id: int, form28_data: Form28Update, user_id: int) -> Optional[Form28]:
        """Update a form28 record"""
        try:
            form28 = self.get_form28(form28_id)
            if not form28:
                return None
    ...
    def delete_form28(self, form28_id: int, user_id: int) -> bool:
    ...
    def change_status(self, form28_id: int, status: bool, user_id: int) -> bool:
