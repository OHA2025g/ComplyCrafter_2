...
class INC28Service:
    ...
    def create_inc28(self, inc28_data: INC28Create, user_id: int) -> INC28:
    ...
    def get_inc28(self, inc28_id: int) -> Optional[INC28]:
        """Get a inc28 by ID"""
        try:
    ...
    def get_inc28s(self, skip: int = 0, limit: int = 100) -> List[INC28]:
    ...
    def get_inc28s_by_company(self, company_id: int) -> List[INC28]:
    ...
    def update_inc28(self, inc28_id: int, inc28_data: INC28Update, user_id: int) -> Optional[INC28]:
    ...
    def delete_inc28(self, inc28_id: int, user_id: int) -> bool:
    ...
    def change_status(self, inc28_id: int, status: bool, user_id: int) -> bool:
