...
class MGT14Service:
    ...
    def create_mgt14(self, mgt14_data: MGT14Create, user_id: int) -> MGT14:
    ...
    def get_mgt14(self, mgt14_id: int) -> Optional[MGT14]:
        """Get a mgt14 by ID"""
        try:
    ...
    def get_mgt14s(self, skip: int = 0, limit: int = 100) -> List[MGT14]:
    ...
    def get_mgt14s_by_company(self, company_id: int) -> List[MGT14]:
    ...
    def update_mgt14(self, mgt14_id: int, mgt14_data: MGT14Update, user_id: int) -> Optional[MGT14]:
    ...
    def delete_mgt14(self, mgt14_id: int, user_id: int) -> bool:
    ...
    def change_status(self, mgt14_id: int, status: bool, user_id: int) -> bool:
