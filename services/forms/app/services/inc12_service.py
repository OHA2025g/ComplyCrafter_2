...
class INC12Service:
    ...
    async def create_inc12(self, inc12_data: INC12Create, user_id: int) -> INC12:
    ...
    async def get_inc12s(self, skip: int = 0, limit: int = 100) -> List[INC12]:
        """Get all active inc12s with pagination"""
        try:
            return list((await self.db.execute(select(INC12).where(
    ...
    async def get_inc12s_by_company(self, company_id: int) -> List[INC12]:
    ...
    async def update_inc12(self, inc12_id: int, inc12_data: INC12Update, user_id: int) -> Optional[INC12]:
    ...
    async def delete_inc12(self, inc12_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, inc12_id: int, status: bool, user_id: int) -> bool:
