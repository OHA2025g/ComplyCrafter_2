...
class STK2Service:
    ...
    async def create_stk2(self, stk2_data: STK2Create, user_id: int) -> STK2:
    ...
    async def get_stk2s(self, skip: int = 0, limit: int = 100) -> List[STK2]:
        """Get all active stk2s with pagination"""
        try:
            return list((await self.db.execute(select(STK2).where(
                STK2.is_active == True
    ...
    async def get_stk2s_by_company(self, company_id: int) -> List[STK2]:
    ...
    async def update_stk2(self, stk2_id: int, stk2_data: STK2Update, user_id: int) -> Optional[STK2]:
    ...
    async def delete_stk2(self, stk2_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, stk2_id: int, status: bool, user_id: int) -> bool:
