...
class GNL1Service:
    ...
    def create_gnl1(self, gnl1_data: GNL1Create, user_id: int) -> GNL1:
    ...
    def get_gnl1(self, gnl1_id: int) -> Optional[GNL1]:
        """Get a gnl1 by ID"""
        try:
    ...
    def get_gnl1s(self, skip: int = 0, limit: int = 100) -> List[GNL1]:
    ...
    def get_gnl1s_by_company(self, company_id: int) -> List[GNL1]:
    ...
    def update_gnl1(self, gnl1_id: int, gnl1_data: GNL1Update, user_id: int) -> Optional[GNL1]:
    ...
    def delete_gnl1(self, gnl1_id: int, user_id: int) -> bool:
    ...
    def change_status(self, gnl1_id: int, status: bool, user_id: int) -> bool:
