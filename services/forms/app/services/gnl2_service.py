...
class GNL2Service:
    ...
    def create_gnl2(self, gnl2_data: GNL2Create, user_id: int) -> GNL2:
    ...
    def get_gnl2(self, gnl2_id: int) -> Optional[GNL2]:
        """Get a gnl2 by ID"""
        try:
    ...
    def get_gnl2s(self, skip: int = 0, limit: int = 100) -> List[GNL2]:
    ...
    def get_gnl2s_by_company(self, company_id: int) -> List[GNL2]:
    ...
    def update_gnl2(self, gnl2_id: int, gnl2_data: GNL2Update, user_id: int) -> Optional[GNL2]:
    ...
    def delete_gnl2(self, gnl2_id: int, user_id: int) -> bool:
    ...
    def change_status(self, gnl2_id: int, status: bool, user_id: int) -> bool:
