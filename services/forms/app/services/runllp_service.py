...
class RUNLLPService:
    ...
    def create_runllp(self, runllp_data: RUNLLPCreate, user_id: int) -> RUNLLP:
    ...
    def get_runllp(self, runllp_id: int) -> Optional[RUNLLP]:
        """Get a runllp by ID"""
        try:
    ...
    def get_runllps(self, skip: int = 0, limit: int = 100) -> List[RUNLLP]:
    ...
    def get_runllps_by_company(self, company_id: int) -> List[RUNLLP]:
    ...
    def update_runllp(self, runllp_id: int, runllp_data: RUNLLPUpdate, user_id: int) -> Optional[RUNLLP]:
    ...
    def delete_runllp(self, runllp_id: int, user_id: int) -> bool:
    ...
    def change_status(self, runllp_id: int, status: bool, user_id: int) -> bool:
