...
class DIR9Service:
    ...
    def create_dir9(self, dir9_data: DIR9Create, user_id: int) -> DIR9:
    ...
    def get_dir9(self, dir9_id: int) -> Optional[DIR9]:
        """Get a dir9 by ID"""
        try:
    ...
    def get_dir9s(self, skip: int = 0, limit: int = 100) -> List[DIR9]:
    ...
    def get_dir9s_by_company(self, company_id: int) -> List[DIR9]:
    ...
    def update_dir9(self, dir9_id: int, dir9_data: DIR9Update, user_id: int) -> Optional[DIR9]:
    ...
    def delete_dir9(self, dir9_id: int, user_id: int) -> bool:
    ...
    def change_status(self, dir9_id: int, status: bool, user_id: int) -> bool:
