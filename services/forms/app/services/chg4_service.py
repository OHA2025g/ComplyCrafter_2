...
class CHG4Service:
    ...
    def create_chg4(self, chg4_data: CHG4Create, user_id: int) -> CHG4:
    ...
    def get_chg4(self, chg4_id: int) -> Optional[CHG4]:
        """Get a chg4 by ID"""
        try:
    ...
    def get_chg4s(self, skip: int = 0, limit: int = 100) -> List[CHG4]:
    ...
    def get_chg4s_by_company(self, company_id: int) -> List[CHG4]:
    ...
    def update_chg4(self, chg4_id: int, chg4_data: CHG4Update, user_id: int) -> Optional[CHG4]:
    ...
    def delete_chg4(self, chg4_id: int, user_id: int) -> bool:
    ...
    def change_status(self, chg4_id: int, status: bool, user_id: int) -> bool:
