...
class SH8Service:
    ...
    async def create_sh8(self, sh8_data: SH8Create, user_id: int) -> SH8:
    ...
    async def get_sh8s(self, skip: int = 0, limit: int = 100) -> List[SH8]:
        """Get all active sh8s with pagination"""
        try:
            return list((await self.db.execute(select(SH8).where(
                SH8.is_active == True
    ...
    async def get_sh8s_by_company(self, company_id: int) -> List[SH8]:
    ...
    async def update_sh8(self, sh8_id: int, sh8_data: SH8Update, user_id: int) -> Optional[SH8]:
        """Update a sh8 record"""
        try:
    ...
    async def delete_sh8(self, sh8_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, sh8_id: int, status: bool, user_id: int) -> bool:
