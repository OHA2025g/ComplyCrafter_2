...
class INC4Service:
    ...
    async def create_inc4(self, inc4_data: INC4Create, user_id: int) -> INC4:
    ...
    async def get_inc4s(self, skip: int = 0, limit: int = 100) -> List[INC4]:
        """Get all active inc4s with pagination"""
        try:
            return list((await self.db.execute(select(INC4).where(
                INC4.is_active == True
    ...
    async def get_inc4s_by_company(self, company_id: int) -> List[INC4]:
    ...
    async def update_inc4(self, inc4_id: int, inc4_data: INC4Update, user_id: int) -> Optional[INC4]:
    ...
    async def delete_inc4(self, inc4_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, inc4_id: int, status: bool, user_id: int) -> bool:
