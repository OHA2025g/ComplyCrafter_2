...
class PAS6Service:
    ...
    async def create_pas6(self, pas6_data: PAS6Create, user_id: int) -> PAS6:
    ...
    async def get_pas6s(self, skip: int = 0, limit: int = 100) -> List[PAS6]:
        """Get all active pas6s with pagination"""
        try:
            return list((await self.db.execute(select(PAS6).where(
                PAS6.is_active == True
    ...
    async def get_pas6s_by_company(self, company_id: int) -> List[PAS6]:
    ...
    async def update_pas6(self, pas6_id: int, pas6_data: PAS6Update, user_id: int) -> Optional[PAS6]:
    ...
    async def delete_pas6(self, pas6_id: int, user_id: int) -> bool:
    ...
    async def change_status(self, pas6_id: int, status: bool, user_id: int) -> bool:
