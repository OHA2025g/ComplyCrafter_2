...
class DIR12Service:
    ...
    def create_dir12(self, dir12_data: DIR12Create, user_id: int) -> DIR12:
    ...
    def get_dir12(self, dir12_id: int) -> Optional[DIR12]:
        """Get a dir12 by ID"""
        try:
    ...
    def get_dir12s(self, skip: int = 0, limit: int = 100) -> List[DIR12]:
    ...
    def get_dir12s_by_company(self, company_id: int) -> List[DIR12]:
    ...
    def update_dir12(self, dir12_id: int, dir12_data: DIR12Update, user_id: int) -> Optional[DIR12]:
    ...
    def delete_dir12(self, dir12_id: int, user_id: int) -> bool:
    ...
    def change_status(self, dir12_id: int, status: bool, user_id: int) -> bool:
