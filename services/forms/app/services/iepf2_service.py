...
class IEPF2Service:
    ...
    def create_iepf2(self, iepf2_data: IEPF2Create, user_id: int) -> IEPF2:
    ...
    def get_iepf2(self, iepf2_id: int) -> Optional[IEPF2]:
        """Get a iepf2 by ID"""
        try:
    ...
    def get_iepf2s(self, skip: int = 0, limit: int = 100) -> List[IEPF2]:
    ...
    def get_iepf2s_by_company(self, company_id: int) -> List[IEPF2]:
    ...
    def update_iepf2(self, iepf2_id: int, iepf2_data: IEPF2Update, user_id: int) -> Optional[IEPF2]:
    ...
    def delete_iepf2(self, iepf2_id: int, user_id: int) -> bool:
    ...
    def change_status(self, iepf2_id: int, status: bool, user_id: int) -> bool:
