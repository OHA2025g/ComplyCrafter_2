...
class INC22Service:
    ...
    def create_inc22(self, inc22_data: INC22Create, user_id: int) -> INC22:
    ...
    def get_inc22(self, inc22_id: int) -> Optional[INC22]:
        """Get a inc22 by ID"""
        try:
    ...
    def get_inc22s(self, skip: int = 0, limit: int = 100) -> List[INC22]:
    ...
    def get_inc22s_by_company(self, company_id: int) -> List[INC22]:
    ...
    def update_inc22(self, inc22_id: int, inc22_data: INC22Update, user_id: int) -> Optional[INC22]:
    ...
    def delete_inc22(self, inc22_id: int, user_id: int) -> bool:
    ...
    def change_status(self, inc22_id: int, status: bool, user_id: int) -> bool:
