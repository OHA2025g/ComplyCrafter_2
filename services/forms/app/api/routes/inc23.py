...
async def create_inc23(
    ...
    try:
        ...
        inc23 = await inc23_service.create_inc23(inc23_data, current_user.id)
        return inc23
...
async def get_inc23s(
    ...
    try:
        inc23_service = INC23Service(db)
        inc23s = await inc23_service.get_inc23s(skip=skip, limit=limit)
        return inc23s
    except Exception as e:
...
async def get_inc23(
    ...
    try:
        inc23_service = INC23Service(db)
        inc23 = await inc23_service.get_inc23(inc23_id)
        if not inc23:
            raise HTTPException(
...
async def update_inc23(
    ...
    try:
        inc23_service = INC23Service(db)
        inc23 = await inc23_service.update_inc23(inc23_id, inc23_data, current_user.id)
        if not inc23:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="INC23 not found"
...
async def delete_inc23(
    ...
    try:
        inc23_service = INC23Service(db)
        success = await inc23_service.delete_inc23(inc23_id, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="INC23 not found"
...
async def get_inc23s_by_company(
    ...
    try:
        inc23_service = INC23Service(db)
        inc23s = await inc23_service.get_inc23s_by_company(company_id)
        return inc23s
    except Exception as e:
...
async def change_inc23_status(
    ...
    try:
        inc23_service = INC23Service(db)
        success = await inc23_service.change_status(inc23_id, status, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="INC23 not found"
