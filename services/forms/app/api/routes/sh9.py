...
async def create_sh9(
    ...
    try:
        ...
        sh9 = sh9_service.create_sh9(sh9_data, current_user.id)
        return sh9
...
async def get_sh9s(
    ...
    try:
        sh9_service = SH9Service(db)
        sh9s = sh9_service.get_sh9s(skip=skip, limit=limit)
        return sh9s
    except Exception as e:
...
async def get_sh9(
    ...
    try:
        sh9_service = SH9Service(db)
        sh9 = sh9_service.get_sh9(sh9_id)
        if not sh9:
            raise HTTPException(
...
async def update_sh9(
    ...
    try:
        sh9_service = SH9Service(db)
        sh9 = sh9_service.update_sh9(sh9_id, sh9_data, current_user.id)
        if not sh9:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="SH9 not found"
...
async def delete_sh9(
    ...
    try:
        sh9_service = SH9Service(db)
        success = sh9_service.delete_sh9(sh9_id, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="SH9 not found"
...
async def get_sh9s_by_company(
    ...
    try:
        sh9_service = SH9Service(db)
        sh9s = sh9_service.get_sh9s_by_company(company_id)
        return sh9s
    except Exception as e:
...
async def change_sh9_status(
    ...
    try:
        sh9_service = SH9Service(db)
        success = sh9_service.change_status(sh9_id, status, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="SH9 not found"
