...
async def create_form4(
    ...
    try:
        ...
        form4 = await form4_service.create_form4(form4_data, current_user.id)
        return form4
...
async def get_form4s(
    ...
    try:
        form4_service = Form4Service(db)
        form4s = await form4_service.get_form4s(skip=skip, limit=limit)
        return form4s
    except Exception as e:
...
async def get_form4(
    ...
    try:
        form4_service = Form4Service(db)
        form4 = await form4_service.get_form4(form4_id)
        if not form4:
            raise HTTPException(
...
async def update_form4(
    ...
    try:
        form4_service = Form4Service(db)
        form4 = await form4_service.update_form4(form4_id, form4_data, current_user.id)
        if not form4:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Form4 not found"
...
async def delete_form4(
    ...
    try:
        form4_service = Form4Service(db)
        success = await form4_service.delete_form4(form4_id, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Form4 not found"
...
async def get_form4s_by_company(
    ...
    try:
        form4_service = Form4Service(db)
        form4s = await form4_service.get_form4s_by_company(company_id)
        return form4s
    except Exception as e:
...
async def change_form4_status(
    ...
    try:
        form4_service = Form4Service(db)
        success = await form4_service.change_status(form4_id, status, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Form4 not found"
