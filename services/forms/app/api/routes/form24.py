...
async def create_form24(
    ...
    try:
        ...
        form24 = await form24_service.create_form24(form24_data, current_user.id)
        return form24
...
async def get_form24s(
    ...
    try:
        form24_service = Form24Service(db)
        form24s = await form24_service.get_form24s(skip=skip, limit=limit)
        return form24s
    except Exception as e:
...
async def get_form24(
    ...
    try:
        form24_service = Form24Service(db)
        form24 = await form24_service.get_form24(form24_id)
        if not form24:
            raise HTTPException(
...
async def update_form24(
    ...
    try:
        form24_service = Form24Service(db)
        form24 = await form24_service.update_form24(form24_id, form24_data, current_user.id)
        if not form24:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Form24 not found"
...
async def delete_form24(
    ...
    try:
        form24_service = Form24Service(db)
        success = await form24_service.delete_form24(form24_id, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Form24 not found"
...
async def get_form24s_by_company(
    ...
    try:
        form24_service = Form24Service(db)
        form24s = await form24_service.get_form24s_by_company(company_id)
        return form24s
    except Exception as e:
...
async def change_form24_status(
    ...
    try:
        form24_service = Form24Service(db)
        success = await form24_service.change_status(form24_id, status, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Form24 not found"
