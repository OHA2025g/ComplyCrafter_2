...
async def create_form22(
    ...
    try:
        ...
        form22 = form22_service.create_form22(form22_data, current_user.id)
        return form22
...
async def get_form22s(
    ...
    try:
        form22_service = Form22Service(db)
        form22s = form22_service.get_form22s(skip=skip, limit=limit)
        return form22s
    except Exception as e:
...
async def get_form22(
    ...
    try:
        form22_service = Form22Service(db)
        form22 = form22_service.get_form22(form22_id)
        if not form22:
            raise HTTPException(
...
async def update_form22(
    ...
    try:
        form22_service = Form22Service(db)
        form22 = form22_service.update_form22(form22_id, form22_data, current_user.id)
        if not form22:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Form22 not found"
...
async def delete_form22(
    ...
    try:
        form22_service = Form22Service(db)
        success = form22_service.delete_form22(form22_id, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Form22 not found"
...
async def get_form22s_by_company(
    ...
    try:
        form22_service = Form22Service(db)
        form22s = form22_service.get_form22s_by_company(company_id)
        return form22s
    except Exception as e:
...
async def change_form22_status(
    ...
    try:
        form22_service = Form22Service(db)
        success = form22_service.change_status(form22_id, status, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Form22 not found"
