...
async def create_dir3(
    ...
    try:
        ...
        dir3 = dir3_service.create_dir3(dir3_data, current_user.id)
        return dir3
...
async def get_dir3s(
    ...
    try:
        dir3_service = DIR3Service(db)
        dir3s = dir3_service.get_dir3s(skip=skip, limit=limit)
        return dir3s
    except Exception as e:
...
async def get_dir3(
    ...
    try:
        dir3_service = DIR3Service(db)
        dir3 = dir3_service.get_dir3(dir3_id)
        if not dir3:
            raise HTTPException(
...
async def update_dir3(
    ...
    try:
        dir3_service = DIR3Service(db)
        dir3 = dir3_service.update_dir3(dir3_id, dir3_data, current_user.id)
        if not dir3:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="DIR3 not found"
...
async def delete_dir3(
    ...
    try:
        dir3_service = DIR3Service(db)
        success = dir3_service.delete_dir3(dir3_id, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="DIR3 not found"
...
async def get_dir3s_by_company(
    ...
    try:
        dir3_service = DIR3Service(db)
        dir3s = dir3_service.get_dir3s_by_company(company_id)
        return dir3s
    except Exception as e:
...
async def change_dir3_status(
    ...
    try:
        dir3_service = DIR3Service(db)
        success = dir3_service.change_status(dir3_id, status, current_user.id)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="DIR3 not found"
