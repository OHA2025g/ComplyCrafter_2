...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class DIR5Controller : BaseController<DIR5, DIR5View>
    {
        private readonly IDIR5 _impl;

        public DIR5Controller(IDIR5 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<DIR5View> GetByCompany(int id = 0)
        {
            IEnumerable<DIR5View> res = _impl.GetByCompany(id);
            return res;
