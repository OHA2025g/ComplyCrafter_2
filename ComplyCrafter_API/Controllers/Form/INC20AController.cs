...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class INC20AController : BaseController<INC20A, INC20AView>
    {
        private readonly IINC20A _impl;

        public INC20AController(IINC20A impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<INC20AView> GetByCompany(int id = 0)
        {
            IEnumerable<INC20AView> res = _impl.GetByCompany(id);
            return res;
