...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class FORM15Controller : BaseController<FORM15, FORM15View>
    {
        private readonly IFORM15 _impl;

        public FORM15Controller(IFORM15 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<FORM15View> GetByCompany(int id = 0)
        {
            IEnumerable<FORM15View> res = _impl.GetByCompany(id);
            return res;
