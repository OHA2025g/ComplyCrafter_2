...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class MGT14Controller : BaseController<MGT14, MGT14View>
    {
        private readonly IMGT14 _impl;

        public MGT14Controller(IMGT14 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<MGT14View> GetByCompany(int id = 0)
        {
            IEnumerable<MGT14View> res = _impl.GetByCompany(id);
            return res;
