...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class AOC4Controller : BaseController<AOC4, AOC4View>
    {
        private readonly IAOC4 _impl;

        public AOC4Controller(IAOC4 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<AOC4View> GetByCompany(int id = 0)
        {
            IEnumerable<AOC4View> res = _impl.GetByCompany(id);
            return res;
