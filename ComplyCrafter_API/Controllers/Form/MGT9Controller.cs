...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class MGT9Controller : BaseController<MGT9, MGT9View>
    {
        private readonly IMGT9 _impl;

        public MGT9Controller(IMGT9 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<MGT9View> GetByCompany(int id = 0)
        {
            IEnumerable<MGT9View> res = _impl.GetByCompany(id);
            return res;
