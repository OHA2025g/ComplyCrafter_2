...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class FORM11Controller : BaseController<FORM11, FORM11View>
    {
        private readonly IFORM11 _impl;

        public FORM11Controller(IFORM11 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<FORM11View> GetByCompany(int id = 0)
        {
            IEnumerable<FORM11View> res = _impl.GetByCompany(id);
            return res;
