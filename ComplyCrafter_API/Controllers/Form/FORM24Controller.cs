...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class FORM24Controller : BaseController<FORM24, FORM24View>
    {
        private readonly IFORM24 _impl;

        public FORM24Controller(IFORM24 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<FORM24View> GetByCompany(int id = 0)
        {
            IEnumerable<FORM24View> res = _impl.GetByCompany(id);
            return res;
