...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class INC12Controller : BaseController<INC12, INC12View>
    {
        private readonly IINC12 _impl;

        public INC12Controller(IINC12 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<INC12View> GetByCompany(int id = 0)
        {
            IEnumerable<INC12View> res = _impl.GetByCompany(id);
            return res;
