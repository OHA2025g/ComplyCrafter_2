...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class FORM22Controller : BaseController<FORM22, FORM22View>
    {
        private readonly IFORM22 _impl;

        public FORM22Controller(IFORM22 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<FORM22View> GetByCompany(int id = 0)
        {
            IEnumerable<FORM22View> res = _impl.GetByCompany(id);
            return res;
