...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class CHG9Controller : BaseController<CHG9, CHG9View>
    {
        private readonly ICHG9 _impl;

        public CHG9Controller(ICHG9 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<CHG9View> GetByCompany(int id = 0)
        {
            IEnumerable<CHG9View> res = _impl.GetByCompany(id);
            return res;
