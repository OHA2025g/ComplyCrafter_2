...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class ADT3Controller : BaseController<ADT3, ADT3View>
    {
        private readonly IADT3 _impl;

        public ADT3Controller(IADT3 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<ADT3View> GetByCompany(int id = 0)
        {
            IEnumerable<ADT3View> res = _impl.GetByCompany(id);
            return res;
