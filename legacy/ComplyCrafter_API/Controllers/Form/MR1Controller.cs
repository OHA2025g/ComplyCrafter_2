...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class MR1Controller : BaseController<MR1, MR1View>
    {
        private readonly IMR1 _impl;

        public MR1Controller(IMR1 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<MR1View> GetByCompany(int id = 0)
        {
            IEnumerable<MR1View> res = _impl.GetByCompany(id);
            return res;
