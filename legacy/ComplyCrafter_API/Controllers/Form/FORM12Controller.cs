...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class FORM12Controller : BaseController<FORM12, FORM12View>
    {
        private readonly IFORM12 _impl;

        public FORM12Controller(IFORM12 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<FORM12View> GetByCompany(int id = 0)
        {
            IEnumerable<FORM12View> res = _impl.GetByCompany(id);
            return res;
