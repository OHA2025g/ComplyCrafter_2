...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class CHG8Controller : BaseController<CHG8, CHG8View>
    {
        private readonly ICHG8 _impl;

        public CHG8Controller(ICHG8 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<CHG8View> GetByCompany(int id = 0)
        {
            IEnumerable<CHG8View> res = _impl.GetByCompany(id);
            return res;
