...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class INC23Controller : BaseController<INC23, INC23View>
    {
        private readonly IINC23 _impl;

        public INC23Controller(IINC23 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<INC23View> GetByCompany(int id = 0)
        {
            IEnumerable<INC23View> res = _impl.GetByCompany(id);
            return res;
