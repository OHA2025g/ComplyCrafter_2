...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class INC22Controller : BaseController<INC22, INC22View>
    {
        private readonly IINC22 _impl;

        public INC22Controller(IINC22 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<INC22View> GetByCompany(int id = 0)
        {
            IEnumerable<INC22View> res = _impl.GetByCompany(id);
            return res;
