...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class MGT8Controller : BaseController<MGT8, MGT8View>
    {
        private readonly IMGT8 _impl;

        public MGT8Controller(IMGT8 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<MGT8View> GetByCompany(int id = 0)
        {
            IEnumerable<MGT8View> res = _impl.GetByCompany(id);
            return res;
