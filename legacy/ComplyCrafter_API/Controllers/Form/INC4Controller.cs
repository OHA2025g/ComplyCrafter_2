...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class INC4Controller : BaseController<INC4, INC4View>
    {
        private readonly IINC4 _impl;

        public INC4Controller(IINC4 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<INC4View> GetByCompany(int id = 0)
        {
            IEnumerable<INC4View> res = _impl.GetByCompany(id);
            return res;
