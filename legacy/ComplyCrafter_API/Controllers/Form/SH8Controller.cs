...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class SH8Controller : BaseController<SH8, SH8View>
    {
        private readonly ISH8 _impl;

        public SH8Controller(ISH8 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<SH8View> GetByCompany(int id = 0)
        {
            IEnumerable<SH8View> res = _impl.GetByCompany(id);
            return res;
