...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class GNL2Controller : BaseController<GNL2, GNL2View>
    {
        private readonly IGNL2 _impl;

        public GNL2Controller(IGNL2 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<GNL2View> GetByCompany(int id = 0)
        {
            IEnumerable<GNL2View> res = _impl.GetByCompany(id);
            return res;
