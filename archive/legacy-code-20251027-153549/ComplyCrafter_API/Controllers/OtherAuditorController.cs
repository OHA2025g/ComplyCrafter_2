...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class OtherAuditorController : BaseController<OtherAuditor,OtherAuditorView>
    {
        private readonly IOtherAuditor _impl;
        private readonly IApiLog _apiLog;

        public OtherAuditorController(IOtherAuditor impl, IApiLog apiLog) : base(impl)
        {
            this._impl = impl;
            _apiLog = apiLog;
        }
        ...
        [HttpGet("List")]
        public IEnumerable<OtherAuditorView> List(int companyId, string type = "")
        {
            return _impl.Gets(companyId, type);
        }

        [HttpGet("ById")]
        public OtherAuditorView? GetById(int id)
        {
            return _impl.GetById(id);
        }

        [HttpPost("Save")]
        public virtual Response Save(OtherAuditor obj)
        {
        ...
        [HttpGet("DT")]
        public IEnumerable<OtherAuditorView> Get(string type = "")
        {
            var res = _impl.Get();
        ...
        {
            OtherAuditor? obj = _impl.GetById(id);
            if (obj.IsNull())
        ...
        //{
        //    OtherAuditor? obj = _impl.GetByDin(din);
        //    if (!obj.IsNull())
        ...
        //    }
        //    obj = new OtherAuditor()
        //    {
        //        Details = new OtherAuditorDetails() { },
        ...
        //[HttpGet("S2")]
        //public IEnumerable<OtherAuditorView> AllSelect2(string q = "")
        //{
        //    var list = _impl.Get();
