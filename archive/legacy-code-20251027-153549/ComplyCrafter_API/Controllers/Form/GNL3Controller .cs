...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class GNL3Controller : BaseController<GNL3, GNL3View>
    {
        private readonly IGNL3 _impl;

        public GNL3Controller(IGNL3 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<GNL3View> GetByCompany(int id = 0)
        {
            IEnumerable<GNL3View> res = _impl.GetByCompany(id);
            return res;
