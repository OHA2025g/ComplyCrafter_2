...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class FORM23Controller : BaseController<FORM23, FORM23View>
    {
        private readonly IFORM23 _impl;

        public FORM23Controller(IFORM23 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<FORM23View> GetByCompany(int id = 0)
        {
            IEnumerable<FORM23View> res = _impl.GetByCompany(id);
            return res;
