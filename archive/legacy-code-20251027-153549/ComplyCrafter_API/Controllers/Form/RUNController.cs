...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class RUNController : BaseController<RUN, RUNView>
    {
        private readonly IRUN _impl;

        public RUNController(IRUN impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<RUNView> GetByCompany(int id = 0)
        {
            IEnumerable<RUNView> res = _impl.GetByCompany(id);
            return res;
