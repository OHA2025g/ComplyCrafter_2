...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class MSMEController : BaseController<MSME, MSMEView>
    {
        private readonly IMSME _impl;

        public MSMEController(IMSME impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<MSMEView> GetByCompany(int id = 0)
        {
            IEnumerable<MSMEView> res = _impl.GetByCompany(id);
            return res;
