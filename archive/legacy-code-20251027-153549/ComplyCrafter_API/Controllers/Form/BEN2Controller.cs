...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class BEN2Controller : BaseController<BEN2, BEN2View>
    {
        private readonly IBEN2 _impl;

        public BEN2Controller(IBEN2 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<BEN2View> GetByCompany(int id = 0)
        {
            IEnumerable<BEN2View> res = _impl.GetByCompany(id);
            return res;
