...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class PAS6Controller : BaseController<PAS6, PAS6View>
    {
        private readonly IPAS6 _impl;

        public PAS6Controller(IPAS6 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<PAS6View> GetByCompany(int id = 0)
        {
            IEnumerable<PAS6View> res = _impl.GetByCompany(id);
            return res;
