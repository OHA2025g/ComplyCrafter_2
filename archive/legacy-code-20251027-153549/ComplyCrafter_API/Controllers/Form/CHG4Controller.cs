...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class CHG4Controller : BaseController<CHG4, CHG4View>
    {
        private readonly ICHG4 _impl;
        public CHG4Controller(ICHG4 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<CHG4View> GetByCompany(int id = 0)
        {
            IEnumerable<CHG4View> res = _impl.GetByCompany(id);
            return res;
