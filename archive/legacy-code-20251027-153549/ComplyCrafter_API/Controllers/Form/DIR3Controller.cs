...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class DIR3Controller : BaseController<DIR3, DIR3View>
    {
        private readonly IDIR3 _impl;

        public DIR3Controller(IDIR3 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<DIR3View> GetByCompany(int id = 0)
        {
            IEnumerable<DIR3View> res = _impl.GetByCompany(id);
            return res;
