...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class SH7Controller : BaseController<SH7, SH7View>
    {
        private readonly ISH7 _impl;

        public SH7Controller(ISH7 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<SH7View> GetByCompany(int id = 0)
        {
            IEnumerable<SH7View> res = _impl.GetByCompany(id);
            return res;
