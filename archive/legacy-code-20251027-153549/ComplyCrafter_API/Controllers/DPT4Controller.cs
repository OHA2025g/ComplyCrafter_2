...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class DPT4Controller : BaseController<DPT4, DPT4View>
    {
        private readonly IDPT4 _impl;

        public DPT4Controller(IDPT4 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<DPT4View> GetByCompany(int id = 0)
        {
            IEnumerable<DPT4View> res = _impl.GetByCompany(id);
            return res;
