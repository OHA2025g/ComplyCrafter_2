...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class STK2Controller : BaseController<STK2, STK2View>
    {
        private readonly ISTK2 _impl;

        public STK2Controller(ISTK2 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<STK2View> GetByCompany(int id = 0)
        {
            IEnumerable<STK2View> res = _impl.GetByCompany(id);
            return res;
