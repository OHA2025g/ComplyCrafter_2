...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class FORM4Controller : BaseController<FORM4, FORM4View>
    {
        private readonly IFORM4 _impl;

        public FORM4Controller(IFORM4 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<FORM4View> GetByCompany(int id = 0)
        {
            IEnumerable<FORM4View> res = _impl.GetByCompany(id);
            return res;
