...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class CHG6Controller : BaseController<CHG6, CHG6View>
    {
        private readonly ICHG6 _impl;

        public CHG6Controller(ICHG6 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<CHG6View> GetByCompany(int id = 0)
        {
            IEnumerable<CHG6View> res = _impl.GetByCompany(id);
            return res;
