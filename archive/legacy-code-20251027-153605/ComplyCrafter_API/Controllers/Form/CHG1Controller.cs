...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class CHG1Controller : BaseController<CHG1, CHG1View>
    {
        private readonly ICHG1 _impl;
        public CHG1Controller(ICHG1 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<CHG1View> GetByCompany(int id = 0)
        {
            IEnumerable<CHG1View> res = _impl.GetByCompany(id);
            return res;
