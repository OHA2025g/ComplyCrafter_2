...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class SH9Controller : BaseController<SH9, SH9View>
    {
        private readonly ISH9 _impl;

        public SH9Controller(ISH9 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<SH9View> GetByCompany(int id = 0)
        {
            IEnumerable<SH9View> res = _impl.GetByCompany(id);
            return res;
