...
namespace ComplyCrafter_API.Controllers
{
    ...
    public class FORM5Controller : BaseController<FORM5, FORM5View>
    {
        private readonly IFORM5 _impl;

        public FORM5Controller(IFORM5 impl) : base(impl)
        {
            this._impl = impl;
        }
        ...
        public IEnumerable<FORM5View> GetByCompany(int id = 0)
        {
            IEnumerable<FORM5View> res = _impl.GetByCompany(id);
            return res;
