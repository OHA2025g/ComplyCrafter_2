...
**Form Code:** DIR3  
**Form Name:** Application for Allotment of DIN  
**Regulation:** Companies Act, 2013 - Section 153  
**Filing Timeline:** Before appointment  
**Field Count:** 70  
**Status:** ✅ Migrated
...
### 4. List All DIR3 Forms

```http
GET /api/dir3/?skip=0&limit=100
Authorization: Bearer {token}
...
```http
GET /api/dir3/company/{company_id}
Authorization: Bearer {token}
...
```http
PATCH /api/dir3/{id}/status/{status}
Authorization: Bearer {token}
...
CREATE TABLE tbl_dir3 (
    ...
    -- Constraints
    CONSTRAINT ck_dir3_cin_length CHECK (LENGTH(cin) = 21),
    
    -- Indexes
    INDEX idx_dir3_company (company_id),
    INDEX idx_dir3_cin (cin),
    INDEX idx_dir3_active (is_active),
    INDEX idx_dir3_created (created_on)
);

-- View for joined data
CREATE VIEW vw_dir3 AS
SELECT 
    f.*,
...
```typescript
// File: frontend/apps/portal/src/app/forms/dir3/dir3.component.ts
...
export class DIR3Component implements OnInit {
  ...
  onSubmit(): void {
    if (this.dir3Form.valid) {
      this.dir3Service.createDIR3(this.dir3Form.value)
        .subscribe({
...
```python
# File: services/forms/app/services/dir3_service.py

from sqlalchemy.orm import Session
from sqlalchemy import and_
from typing import List, Optional
from ..models.dir3 import DIR3, DIR3Create, DIR3Update
import logging
...
class DIR3Service:
    ...
    async def get_dir3(self, dir3_id: int) -> Optional[DIR3]:
        """Get DIR3 by ID"""
        return await self.db.query(DIR3).filter(
            and_(
                DIR3.id == dir3_id,
                DIR3.is_active == True
            )
    ...
    async def get_dir3s_by_company(
        ...
        """Get all DIR3 forms for a company"""
        return await self.db.query(DIR3).filter(
            and_(
...
```python
# File: services/forms/app/api/routes/dir3.py

from fastapi import APIRouter, Depends, HTTPException, status
from sqlalchemy.orm import Session
from typing import List
from ..dependencies import get_current_user, get_db
from ...models.dir3 import DIR3, DIR3Create
...
async def create_dir3(
    ...
    """Create new DIR3 form"""
    dir3_service = DIR3Service(db)
    return await dir3_service.create_dir3(
        dir3_data, 
        current_user.id
    )

@router.get("/{id}", response_model=DIR3View)
async def get_dir3(
    id: int,
    current_user: User = Depends(get_current_user),
    db: Session = Depends(get_db)
    ...
    """Get DIR3 by ID"""
    dir3_service = DIR3Service(db)
    dir3 = await dir3_service.get_dir3(id)
    if not dir3:
        raise HTTPException(status_code=404, detail="DIR3 not found")
    return dir3
```
...
```python
# File: services/forms/app/models/dir3.py
...
class DIR3Create(DIR3Base):
    pass

class DIR3Update(DIR3Base):
    company_id: Optional[int] = None
    cin: Optional[str] = None
    # All fields optional for partial updates

class DIR3Response(DIR3Base):
    id: int
    created_by: int
    created_on: datetime
    is_active: bool

class DIR3View(DIR3Response):
