...
### 4. List All FORM28 Forms

```http
GET /api/form28/?skip=0&limit=100
Authorization: Bearer {token}
...
```http
GET /api/form28/company/{company_id}
Authorization: Bearer {token}
...
```http
PATCH /api/form28/{id}/status/{status}
Authorization: Bearer {token}
...
CREATE TABLE tbl_form28 (
    ...
    -- Constraints
    CONSTRAINT ck_form28_cin_length CHECK (LENGTH(cin) = 21),
    
    -- Indexes
    INDEX idx_form28_company (company_id),
    INDEX idx_form28_cin (cin),
    INDEX idx_form28_active (is_active),
    INDEX idx_form28_created (created_on)
);

-- View for joined data
CREATE VIEW vw_form28 AS
SELECT 
    f.*,
...
```typescript
// File: frontend/apps/portal/src/app/forms/form28/form28.component.ts
...
export class FORM28Component implements OnInit {
  ...
  onSubmit(): void {
    if (this.form28Form.valid) {
      this.form28Service.createFORM28(this.form28Form.value)
        .subscribe({
...
```python
# File: services/forms/app/services/form28_service.py

from sqlalchemy.orm import Session
from sqlalchemy import and_
from typing import List, Optional
from ..models.form28 import FORM28, FORM28Create, FORM28Update
import logging
...
class FORM28Service:
    ...
    async def get_form28(self, form28_id: int) -> Optional[FORM28]:
        """Get FORM28 by ID"""
        return await self.db.query(FORM28).filter(
            and_(
                FORM28.id == form28_id,
    ...
    async def get_form28s_by_company(
        ...
        """Get all FORM28 forms for a company"""
        return await self.db.query(FORM28).filter(
            and_(
...
```python
# File: services/forms/app/api/routes/form28.py

from fastapi import APIRouter, Depends, HTTPException, status
from sqlalchemy.orm import Session
from typing import List
from ..dependencies import get_current_user, get_db
from ...models.form28 import FORM28, FORM28Create
...
async def create_form28(
    ...
    """Create new FORM28 form"""
    form28_service = FORM28Service(db)
    return await form28_service.create_form28(
        form28_data, 
        current_user.id
    )

@router.get("/{id}", response_model=FORM28View)
async def get_form28(
    ...
    """Get FORM28 by ID"""
    form28_service = FORM28Service(db)
    form28 = await form28_service.get_form28(id)
    if not form28:
        raise HTTPException(status_code=404, detail="FORM28 not found")
    return form28
```
...
```python
# File: services/forms/app/models/form28.py
...
class FORM28Create(FORM28Base):
    pass

class FORM28Update(FORM28Base):
    company_id: Optional[int] = None
    cin: Optional[str] = None
    # All fields optional for partial updates

class FORM28Response(FORM28Base):
    id: int
    created_by: int
    created_on: datetime
    is_active: bool

class FORM28View(FORM28Response):
...
Step 1: Login to ComplyCrafter
   ↓
Step 2: Navigate to Forms → FORM28
   ↓
