...
### 4. List All FORM22 Forms

```http
GET /api/form22/?skip=0&limit=100
Authorization: Bearer {token}
...
```http
GET /api/form22/company/{company_id}
Authorization: Bearer {token}
...
```http
PATCH /api/form22/{id}/status/{status}
Authorization: Bearer {token}
...
CREATE TABLE tbl_form22 (
    ...
    -- Constraints
    CONSTRAINT ck_form22_cin_length CHECK (LENGTH(cin) = 21),
    
    -- Indexes
    INDEX idx_form22_company (company_id),
    INDEX idx_form22_cin (cin),
    INDEX idx_form22_active (is_active),
    INDEX idx_form22_created (created_on)
);

-- View for joined data
CREATE VIEW vw_form22 AS
SELECT 
    f.*,
...
```typescript
// File: frontend/apps/portal/src/app/forms/form22/form22.component.ts
...
export class FORM22Component implements OnInit {
  ...
  onSubmit(): void {
    if (this.form22Form.valid) {
      this.form22Service.createFORM22(this.form22Form.value)
        .subscribe({
...
```python
# File: services/forms/app/services/form22_service.py

from sqlalchemy.orm import Session
from sqlalchemy import and_
from typing import List, Optional
from ..models.form22 import FORM22, FORM22Create, FORM22Update
import logging
...
class FORM22Service:
    ...
    async def get_form22(self, form22_id: int) -> Optional[FORM22]:
        """Get FORM22 by ID"""
        return await self.db.query(FORM22).filter(
            and_(
                FORM22.id == form22_id,
    ...
    async def get_form22s_by_company(
        ...
        """Get all FORM22 forms for a company"""
        return await self.db.query(FORM22).filter(
            and_(
...
```python
# File: services/forms/app/api/routes/form22.py

from fastapi import APIRouter, Depends, HTTPException, status
from sqlalchemy.orm import Session
from typing import List
from ..dependencies import get_current_user, get_db
from ...models.form22 import FORM22, FORM22Create
...
async def create_form22(
    ...
    """Create new FORM22 form"""
    form22_service = FORM22Service(db)
    return await form22_service.create_form22(
        form22_data, 
        current_user.id
    )

@router.get("/{id}", response_model=FORM22View)
async def get_form22(
    ...
    """Get FORM22 by ID"""
    form22_service = FORM22Service(db)
    form22 = await form22_service.get_form22(id)
    if not form22:
        raise HTTPException(status_code=404, detail="FORM22 not found")
    return form22
```
...
```python
# File: services/forms/app/models/form22.py
...
class FORM22Create(FORM22Base):
    pass

class FORM22Update(FORM22Base):
    company_id: Optional[int] = None
    cin: Optional[str] = None
    # All fields optional for partial updates

class FORM22Response(FORM22Base):
    id: int
    created_by: int
    created_on: datetime
    is_active: bool

class FORM22View(FORM22Response):
...
Step 1: Login to ComplyCrafter
   ↓
Step 2: Navigate to Forms → FORM22
   ↓
