...
export class EGMComponent implements OnInit {
  meetings: EGM[] = [
    ...
    { srNo: 3, meetingNo: 'EGM-2023-002', meetingDate: '2023-11-10', purpose: 'Change in registered office', venue: 'Corporate Office', status: 'Completed' },
    { srNo: 4, meetingNo: 'EGM-2024-002', meetingDate: '2024-08-25', purpose: 'Approval of related party transactions', venue: 'Conference Hall', status: 'Completed' }
  ];
  filteredData: EGM[] = [];
