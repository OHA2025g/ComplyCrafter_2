      ...
      <div class="content-card">
        <div class="table-controls">
          ...
          <div class="right-controls">
            <button class="btn-add" (click)="addMeeting()">+ Add AGM</button>
        ...
        <div class="table-wrapper">
          <table class="data-table">
            <thead>
              <tr><th>Sr No</th><th>Financial Year</th><th>Meeting Date</th><th>Venue</th><th>Shareholders</th><th>Status</th><th>Action</th></tr>
            </thead>
            <tbody>
              <tr *ngFor="let meeting of getPaginatedData()">
                <td>{{ meeting.srNo }}</td>
                <td><span class="fy-badge">{{ meeting.financialYear }}</span></td>
                <td>{{ meeting.meetingDate }}</td>
                <td>{{ meeting.venue }}</td>
                <td>{{ meeting.shareholders }}</td>
...
export class AGMComponent implements OnInit {
  ...
  filterData(): void {
    this.filteredData = this.searchTerm ? this.meetings.filter(m => m.financialYear.toLowerCase().includes(this.searchTerm.toLowerCase()) || m.venue.toLowerCase().includes(this.searchTerm.toLowerCase())) : [...this.meetings];
  }
  getPaginatedData(): AGM[] { return this.filteredData; }
  addMeeting(): void { alert('Add AGM'); }
}
