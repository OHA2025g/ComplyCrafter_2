...
@Component({
    ...
    <div class="agendas-container">
      ...
      <div class="page-header">
        <div class="header-content">
          <h1>📋 Agenda(s)</h1>
          <p class="subtitle">Manage meeting agendas and agenda items</p>
        </div>
  ...
  styles: [`
    ...
    .agendas-container { padding: 2rem; max-width: 1600px; margin: 0 auto; animation: fadeInUp 0.5s ease-out; }
