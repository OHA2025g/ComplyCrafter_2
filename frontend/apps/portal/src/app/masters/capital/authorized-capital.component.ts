...
@Component({
  selector: 'app-authorized-capital',
  standalone: true,
  ...
  template: `
    <div class="capital-container">
      <div class="page-header">
        ...
        <p class="subtitle">Manage authorized capital structure</p>
      </div>
  ...
  styles: [`
    ...
    .class-badge { background: linear-gradient(135deg, #4facfe, #00f2fe); color: white; padding: 0.35rem 0.85rem; border-radius: 20px; font-size: 0.85rem; font-weight: 700; }
...
export class AuthorizedCapitalComponent implements OnInit {
  capitals: AuthorizedCapital[] = [
    { srNo: 1, shareClass: 'Equity Shares', authorizedShares: 1000000, faceValue: 10, totalAmount: 10000000, amendmentDate: '2023-04-01' },
    { srNo: 2, shareClass: 'Preference Shares', authorizedShares: 500000, faceValue: 100, totalAmount: 50000000, amendmentDate: '2023-04-01' }
  ];
  filteredData: AuthorizedCapital[] = [];
  ...
  getPaginatedData(): AuthorizedCapital[] { return this.filteredData; }
  addCapital(): void { alert('Add authorized capital'); }
}
